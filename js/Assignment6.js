function CustomerMenuChoice()
    {
        ...
        if (document.getElementById("customermenu").value == "Create A Customer")
            {
                document.getElementById("customercreation1").style.display = 'block';
                document.getElementById("orderupdate2").style.display = "none";
        ...
        {
            document.getElementById("customercreation1").style.display = "none";
            document.getElementById("orderupdate2").style.display = 'block';
            document.getElementById("customerdelete3").style.display = "none";
        }
        ...
        else if (document.getElementById("customermenu").value == "Delete A Customer")
        {
            document.getElementById("customercreation1").style.display = "none";
            document.getElementById("orderupdate2").style.display = "none";
            document.getElementById("customerdelete3").style.display = 'block';
        }
